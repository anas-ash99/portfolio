        ...
        <>
            <nav className={cn(
                ...
                <div className="container mx-auto px-6 flex justify-between items-center">
                    ...
                    <div className="hidden md:flex items-center space-x-8 rtl:space-x-reverse">
                        ...
                        <a href="/portfolio/resume.pdf" target="_blank" rel="noopener noreferrer" className="border border-teal-400 text-teal-400 px-4 py-2 rounded hover:bg-teal-400/10 transition-colors text-sm font-medium">
                            {t('navbar.resume')}
                        </a>
                    </div>
            ...
            <div className={cn(
                ...
                <div className="flex flex-col items-center space-y-8">
                    ...
                    <a href="/portfolio/resume.pdf" className="border border-teal-400 text-teal-400 px-8 py-3 rounded hover:bg-teal-400/10 transition-colors text-lg font-medium">
                        {t('navbar.resume')}
                    </a>
                </div>
            </div>
